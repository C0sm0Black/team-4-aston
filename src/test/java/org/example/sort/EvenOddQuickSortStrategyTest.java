...
class EvenOddQuickSortStrategyTest {
    ...
    void shouldSortOnlyEvenValuesAndReturnStrategyName() {
        ...
        assertEquals("EvenOddQuickSort", strategy.getStrategyName());
